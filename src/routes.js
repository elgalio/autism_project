...
const Questionnaires = React.lazy(() => import('./pages/Questionnaires/Questionnaire'));
const Intro1 = React.lazy(() => import('./pages/Questionnaires/Intro1'));
const Intro2 = React.lazy(() => import('./pages/Questionnaires/Intro2'));
const Behaviour = React.lazy(() => import('./pages/Questionnaires/Behaviour'));
const Medical = React.lazy(() => import('./pages/Questionnaires/Medical'));
